...
import kotlinx.android.synthetic.main.fragment_live_data_use2.*

/**
 * Created By：Misaka10085
 * on：2021/11/25
 * package：com.misakanetwork.kotlinlab.jetpack.fragment
 * class name：LiveDataUseFragment2
 * desc：LiveData+ViewModel的使用
 */
class LiveDataUseFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_live_data_use2, null)
    }
